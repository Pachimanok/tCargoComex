...
if($file == null){
  ...
  $row = mysqli_fetch_array($result_file);
    ...
    if(!$result_upload_file){
        ...
        header('Location: https://api.whatsapp.com/send?phone='.$contacto.'&text=Instruccion%20de%20carga%20'.$booking.'%20-%20Shipper:%20'.$shipper.'%20:%20http://botzero.tech/PlataformaTrafico/formularios/instructivos/'.$booking.'/'.$cntr_number.'/'.'instructivo_'.$booking.'_'.$cntr_number.'.pdf');
