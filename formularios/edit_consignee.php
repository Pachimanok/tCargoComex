...
if (isset($_GET['id'])) {   // me traigo la informacion segun ID seleccionada. 
  ...
  $id = $_GET['id'];
   ...
   if (isset($_POST['editar_consignee'])) {
    ...
    $query = "UPDATE `customer.cnee` set razon_social = '$razon_social' , tax_id = '$tax_id' ,andress = '$andress' ,city = '$city' ,country = '$country' ,postal_code = '$postal_code',remarks = '$remarks'  ,create_user = '$user' ,company = '$company' WHERE id = '$id'";
