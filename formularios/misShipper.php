...
$query = "INSERT INTO `customer.shipper` (`razon_social`, `tax_id`, `andress`, `city`, `country`, `postal_code`, `create_user`, `company`, `remarks`) VALUES ('$razon_social','$tax_id','$andress','$city','$country','$postal_code','$user','$company','$remarks')";
