...
use Dompdf\dompdf;
        ...
        $content .= '<p style="font-family: sans-serif; text-align: left; margin: 0.2rem 0 0.2rem 1rem; font-size: medium;">Lugar de Carga: <small style="font-family: sans-serif; color: gray ;font-size: medium;">'.$load_place.' (<a href="'. $link_maps .'"> ' . $andress . ' - ' . $city . '</small></a> )</small></p>';
