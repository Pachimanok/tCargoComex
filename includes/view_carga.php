            ...
            while ($row = mysqli_fetch_assoc($result_modal)) { ?>
                ...
                <div class="modal fade" id="documentacion<?php echo $row['id_cntr']; ?>" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 style="text-align:center;" class="modal-title" id="scrollmodalLabel">Documentación de CNTR <strong><?php echo $row['cntr_number']; ?></strong></h4>
                            </div>
                            <div class="modal-body">
                                <div class="container">
                                            ...
                                            <div class="col-sm-2 mr-2">
                                                <div class="card">
                                                    <div class="card-body" style="text-align: center;">
                                                        ...
                                                        <br>
                                                        <p style="margin-bottom: 0%;margin-top: 9%; font-size: 12px; color:<?php echo $color_interchange; ?>">IN-CH</p>
                                                    </div>
                                            ...
                                            <div class="col-sm-2 mr-2">
                                                <div class="card">
                                                    <div class="card-body" style="text-align: center;">
                                                        ...
                                                        <br>
                                                        <p style="margin-bottom: 0%;margin-top: 9%; font-size: 12px; color:<?php echo $color_document_packing; ?>">PL</p>
                                                    </div>
                                            ...
                                            <div class="col-sm-2 mr-2">
                                                <div class="card">
                                                    <div class="card-body" style="text-align: center;">
                                                        ...
                                                        <br>
                                                        <p style="margin-bottom: 0%;margin-top: 9%; font-size: 12px; color:<?php echo $color_document_invoice; ?>">IN</p>
                                                    </div>
                                            ...
                                            <div class="col-sm-2 mr-2">
                                                <div class="card">
                                                    <div class="card-body" style="text-align: center;">
                                                        ...
                                                        <br>
                                                        <p style="margin-bottom: 0%;margin-top: 9%; font-size: 12px; color:<?php echo $color_cntr_crt; ?>">CRT</p>
                                                    </div>
                                            ...
                                            <div class="col-sm-2 mr-2">
                                                <div class="card">
                                                    <div class="card-body" style="text-align: center;">
                                                        ...
                                                        <br>
                                                        <p style="margin-bottom: 0%;margin-top: 9%; font-size: 12px; color:<?php echo $color_cntr_micdta; ?>">MIC DTA</p>
                                                    </div>
                ...
                <div class="col-sm-2 mr-2">
                    <div class="card">
                        <div class="card-body" style="text-align: center;">
                            ...
                            <br>
                            <p style="margin-bottom: 0%;margin-top: 9%; color:<?php echo $color_document_bookingConf; ?>">Booking</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-2 mr-2">
